      ...
      <div style={{ background: 'var(--background)', minHeight: '100vh', paddingTop: '120px' }}>
        <div className="container" style={{ maxWidth: '860px', paddingBottom: '6rem' }}>
          ...
          >
            ...
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(2.2rem, 8vw, 4rem)', lineHeight: 1.05, margin: '0.8rem 0 1rem' }}>
              Login before applying to partner with Grihamm.
            </h1>
            <p style={{ maxWidth: 680, margin: '0 auto 2rem', color: 'var(--text-muted)', fontSize: '1.05rem', lineHeight: 1.7 }}>
        ...
        {submitted ? (
          ...
          <div>
            <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
              <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(2.3rem, 8vw, 3.5rem)', lineHeight: 1.05, marginBottom: '1rem' }}>
                Partner with <span style={{ color: 'var(--primary)' }}>Grihamm</span>
              </h1>
              <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem' }}>Build your approved profile for residential, corporate, retail, and commercial clients in Bengaluru and Pune.</p>
            </div>

            {/* Progress Bar */}
            <div style={{ display: 'flex', gap: '0.8rem', marginBottom: '3rem', alignItems: 'center' }}>
              {[1, 2, 3].map(i => (
            ...
            <form className="glass" style={{ padding: 'clamp(1.4rem, 5vw, 4rem)', border: '1px solid var(--glass-border)', borderRadius: 10 }} onSubmit={handleSubmit}>
              ...
              {step === 1 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    <label style={{ display: 'block', marginBottom: '0.6rem', fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>Company Name (optional)</label>
